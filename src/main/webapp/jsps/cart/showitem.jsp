...
<script type="text/javascript">
  ...
  <body>
<form id="form1" action="<c:url value='/order/createOrder.action'/>" method="post">
...
<c:forEach items="${cartItemList }" var="cartItem">
	<tr align="center">
		<td align="right">
			<a class="linkImage" href="<c:url value='/book/load.action?bid=${cartItem.bid}'/>"><img border="0" width="54" align="top" src="/${cartItem.image_b }"/></a>
		</td>
		<td align="left">
	...
	<tr>
		<td colspan="6">
			<input id="addr" type="text" name="address" value="吉林省 长春市 前进大街2699号吉大南校南一360寝室 苏航"/>
		</td>
	</tr>
	<tr>
		<td style="border-top-width: 4px;" colspan="5" align="right">
			<a id="linkSubmit" href="javascript:$('#form1').submit();"><img src="/images/tijiao.png"  height="40" width="100" alt=""></a>
		</td>
	</tr>
</table>
</form>
