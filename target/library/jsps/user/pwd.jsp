...
<html>
  ...
  <body>
	...
	<div class="div1">
		<form action="<c:url value='/user/updatePass.action'/>" method="post" target="_top">
		...
		<table>
			...
			<tr>
				...
				<td><label id="newloginpassError" class="error"></label></td>
			</tr>
			<tr>
			...
			<tr>
				<td align="right"></td>
				<td>
				  <img id="vCode" src="${pageContext.request.contextPath}/captcha/getCaptchaImage.action" border="1"/>
