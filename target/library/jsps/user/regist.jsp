...
<script type="text/javascript">
    function doSubmit(){registForm.submit();}
...
<form action="<c:url value='/user/regist.action'/>" method="post" id="registForm">
    ...
    <table id="tableForm">
      ...
      <tr>
        ...
        <td>
          <input class="inputClass" type="password" name="loginpass" id="loginpass" value=""/>
        </td>
        <td>
      ...
      <tr>
        ...
        <td>
          <input class="inputClass" type="password" name="reloginpass" id="reloginpass" value=""/>
        </td>
        <td>
      ...
      <tr>
        ...
        <td>
          ...
          <%--<input id="submitBtn" type="submit" value="立即注册" onclick="doSubmit()"/>--%>
        </td>
          <label></label>
        </td>
      </tr>
