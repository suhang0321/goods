	...
	$(".jian").click(function() {
		...
		if(quantity == 1) {
			if(confirm("您是否真要删除该条目？")) {
				location = "/goods/cart/delete.action?cartItemIds=" + id;
			}
		} else {
...
<c:forEach items="${cartItemList }" var="cartItem">
	...
	<tr>
		<td colspan="7" align="right">
			<a href="javascript:jiesuan();" id="jiesuan" class="jiesuan"><img src="/images/jiesuan.png" height="40" width="100" alt=""></a>
		</td>
	</tr>
</table>
